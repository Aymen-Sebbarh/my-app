                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('users.update',$user->id) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prenom" placeholder="Enter your surname" value="{{$user->prenom}}">
                                            @error('prenom')
                                            <p class="text text-danger">{{$message}}</p>
                                            @enderror</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" name="phone_number" placeholder="Enter phone number" value="{{$user->phone_number}}">
                                            @error('phone_number')
                                            <p class="text text-danger">{{$message}}</p>
                                            @enderror</div>
